...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Test 1 | Random number'),
    );
  }
}
        ...
        Center(
          child: RichText(
           ...
           Flexible(
                ...
                shrinkWrap: true,
                itemCount: previousRandomNumbers.length,
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    child: Center(child: Text(previousRandomNumbers[index].toString())),
                  );
                }
            )),
        ]
